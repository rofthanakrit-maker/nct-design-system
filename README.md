...
**corp เป็นค่าเริ่มต้น** — `<Deck>` เฉย ๆ ได้แบบฟอร์มบริษัท (`brand="web"` ถ้าอยากได้ chrome บ้าน) ฝั่ง PowerPoint เริ่มจาก `NCT-Slide-Template-Corp.potx` — เส้นเต็มความกว้าง, การ์ดโลโก้
มุมขวาบน, แถบสามช่วงที่ก้น — สีใช้ palette เดียวกับเว็บ (teal / navy) ต่างกันแค่ chrome
ฝั่งเว็บสลับได้ใน deck เดียว ฝั่ง PowerPoint ต้องหยิบไฟล์ `-Corp.potx`

สองแบรนด์ **เลือก chrome ทั้งเด็ค ไม่ผสมในสไลด์เดียว** สีเหมือนกันทั้งคู่
